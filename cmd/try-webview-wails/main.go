...
func setupWebview(hwnd w32.HWND, url string, defaultZoom float64) {
	...
	chromium.NavigationCompletedCallback = func(sender *edge.ICoreWebView2, args *edge.ICoreWebView2NavigationCompletedEventArgs) {
		...
		// w32.ShowWindow(hwnd, w32.SW_SHOWMAXIMIZED)
...
func createWindow() w32.HWND {
	...
	/**
	 * set top-left titlebar icon, generated by:
	 * 	Icon Resource generated by: go-winres simply --icon D:\\OneDrive\\Pictures\\2.png --manifest gui
	 */
	//go:generate go-winres simply --icon D:\\OneDrive\\Pictures\\2.png --manifest gui
	hIcon := loadAppIcon()
	wc.Icon = hIcon   // big icon (taskbar / alt-tab)
	wc.IconSm = hIcon // small icon (title bar top-left)
...
func loadAppIcon() w32.HICON {
	instance := w32.GetModuleHandle("")

	return w32.LoadIcon(
		instance,
		w32.MakeIntResource(1), // icon resource ID
	)
}
func runMsgLoop() {
	var msg w32.MSG
